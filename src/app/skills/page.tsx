...
export default function Skills() {
    return (
        ...
        <div className="card w-[250px]  rounded-lg m-[20px] bg-transparent backdrop-blur-md shadow-slate-600 "><Image className="pb-2 mb-5 h-[250px] w-[100%] rounded-lg transition-all" src="html.jpg" alt="html"/>
        ...
        <div className="card w-[250px] rounded-lg m-[20px] bg-transparent backdrop-blur-md shadow-slate-600"><Image className="w-[100%] rounded-lg transition-all h-auto" src="css.jpg" alt="css"/>
            <div className="card-content p-4">
          ...
          <div className="card w-[250px] rounded-lg m-[20px] bg-transparent backdrop-blur-md shadow-slate-600"><Image className="w-[100%] rounded-lg transition-all h-auto" src="js.jpg" alt="js"/>
            <div className="card-content p-4 ">
